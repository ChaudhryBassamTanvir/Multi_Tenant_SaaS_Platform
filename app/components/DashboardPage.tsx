    ...
    <div className="w-full">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-6 sm:space-y-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
          {/* Collected */}
          <div className="relative bg-white aspect-square rounded-2xl shadow hover:shadow-lg transition p-4 sm:p-6 overflow-hidden">
            <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-green-400 to-green-600" />
            <p className="text-xs sm:text-sm font-medium text-gray-500">
              Collected
            </p>
            <p className="mt-3 sm:mt-4 text-2xl sm:text-4xl font-bold text-gray-800">
              $32,400
            </p>
            <p className="mt-auto text-[10px] sm:text-xs text-gray-400">
              Updated today
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="lg:col-span-2 bg-white p-4 sm:p-6 rounded-2xl shadow">
            ...
            <div className="mt-4 sm:mt-6 h-48 sm:h-64 flex items-center justify-center rounded-xl border border-dashed text-gray-400 text-sm">
              Chart goes here
            </div>
          </div>
